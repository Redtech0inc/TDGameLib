...
---@param onErrorCall function|nil if supplied is called before the TDGameLib Runs into an error, may not work ift error notcalled by GameLib it's self!
...
function gameLib:create(gameName,onErrorCall,useMonitor,monitorFilter,pixelSize,screenStartX,screenStartY,screenEndX,screenEndY)
